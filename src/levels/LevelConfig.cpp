...
LevelConfig getLevel1() {
  return {1,
          ...
          70.f,
          {
              {ObstacleType::DINOSAUR, 260.f, 1.f, 180.f,
               "assets/sprites/lv1_sp/dino/dino1.png", 3, 420.f},
              {ObstacleType::DINOSAUR, 280.f, -1.f, 315.f,
               "assets/sprites/lv1_sp/dino/dino2_trai.png", 3, 430.f},
              {ObstacleType::MAMMOTH, 180.f, 1.f, 270.f,
               "assets/sprites/lv1_sp/mammoth/MAMUT.png", 2, 620.f},
              {ObstacleType::DINOSAUR, 240.f, -1.f, 405.f,
               "assets/sprites/lv1_sp/dino/dino3_trai.png", 3, 430.f},
              {ObstacleType::MAMMOTH, 160.f, 1.f, 80.f,
               "assets/sprites/lv1_sp/mammoth/MAMUT.png", 2, 620.f},
          },
          {
              {AnimalType::BIRD, 300.f, 1.f, 50.f,
