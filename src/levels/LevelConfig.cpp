...
LevelConfig getLevel3() {
  return {3,
          ...
          "assets/sprites/lv3_sp/traffic/brazier1.png",
          "assets/sprites/lv3_sp/traffic/brazier.png",
          75,
          80,
...
LevelConfig getLevel4() {
  return {4,
          ...
          {{ObstacleType::CAR, 210.f, 1.f, 320.f,
           ...
           {ObstacleType::MOTOR, 240.f, 1.f, 150.f,
            "assets/sprites/lv4_sp/vehicle_lv4/xe_may_phai.png", 2, 595.f}},
          {{AnimalType::PLANE, 270.f, 1.f, 350.f,
            "assets/sprites/lv4_sp/animal_lv4/may_bay_phai.png", 3, 180.f},
           {AnimalType::MISSILE, 230.f, 1.f, 220.f,
            "assets/sprites/lv4_sp/animal_lv4/ten_lua.png", 3, 346.f},
           {AnimalType::MISSILE, 230.f, -1.f, 420.f,
...
LevelConfig getLevel5() {
  return {5,
          ...
          {{ObstacleType::ECAR, 310.f, 1.f, 505.f,
           ...
           {ObstacleType::ETRAIN, 290.f, 1.f, 150.f,
            "assets/sprites/lv5_sp/vehicle_lv5/tau_dien.png", 3, 629.f},
           {ObstacleType::ETRAIN, 290.f, -1.f, 250.f,
            "assets/sprites/lv5_sp/vehicle_lv5/tau_dien_trai.png", 3, 629.f},
           {ObstacleType::ECAR, 340.f, 1.f, 180.f,
            "assets/sprites/lv5_sp/vehicle_lv5/xe_dien.png", 2, 595.f},
           {ObstacleType::ECAR, 240.f, -1.f, 300.f,
            "assets/sprites/lv5_sp/vehicle_lv5/xe_dien_trai.png", 2, 595.f}},
          {
              {AnimalType::FLYCAR, 300.f, 1.f, 450.f,
               "assets/sprites/lv5_sp/animal_lv5/xe_bay.png", 3, 580.f},
              {AnimalType::FLYCAR, 300.f, -1.f, 250.f,
               "assets/sprites/lv5_sp/animal_lv5/xe_bay_trai.png", 3, 580.f},
              {AnimalType::UFO, 300.f, -1.f, 340.f,
               "assets/sprites/lv5_sp/animal_lv5/ufo_trai.png", 3, 646.f},
              {AnimalType::UFO, 300.f, 1.f, 440.f,
               "assets/sprites/lv5_sp/animal_lv5/ufo.png", 3, 666.f},
              {AnimalType::DRONE, 330.f, 1.f, 360.f,
               "assets/sprites/lv5_sp/animal_lv5/drone.png", 3, 650.f},
