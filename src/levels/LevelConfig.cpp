...
LevelConfig getLevel1() {
  return {1,
          ...
          70.f,
          {
              {ObstacleType::DINOSAUR, 220.f, 1.f, 180.f,
               "assets/sprites/lv1_sp/dino/dino1.png", 2, 520.f},
              {ObstacleType::DINOSAUR, 240.f, -1.f, 315.f,
               "assets/sprites/lv1_sp/dino/dino2_trai.png", 2, 530.f},
              {ObstacleType::MAMMOTH, 160.f, 1.f, 270.f,
               "assets/sprites/lv1_sp/mammoth/MAMUT.png", 2, 620.f},
              {ObstacleType::DINOSAUR, 210.f, -1.f, 405.f,
               "assets/sprites/lv1_sp/dino/dino3_trai.png", 2, 530.f},
              {ObstacleType::MAMMOTH, 150.f, 1.f, 80.f,
               "assets/sprites/lv1_sp/mammoth/MAMUT.png", 2, 620.f},
          },
          {
              {AnimalType::BIRD, 240.f, 1.f, 50.f,
               "assets/sprites/lv1_sp/bird/bay.png", 1, 620.f},
              {AnimalType::BIRD, 230.f, -1.f, 50.f,
               "assets/sprites/lv1_sp/bird/baytrai.png", 1, 620.f},
          }};
}
...
LevelConfig getLevel2() {
  return {2,
          ...
          80,
          60.f,
          {{ObstacleType::SPHINX, 200.f, 1, 300.f,
           ...
           {ObstacleType::SPHINX, 210.f, 1, 185.f,
