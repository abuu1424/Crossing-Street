...
CTRAFFIC_LV5::CTRAFFIC_LV5(std::vector<std::unique_ptr<CVEHICLE>> &vehicles)
    : CTRAFFICLIGHT(vehicles) {}

bool CTRAFFIC_LV5::loadSprite(const std::string &redPath,
...
void CTRAFFIC_LV5::Draw(sf::RenderWindow &w) {
